    ...
    internal sealed class DacteRenderer
    {
        ...
        private void DesenhaModal()
        {
            ...
            else
            {
                ...
                // Aereo / Multimodal com a coluna de minuta atravessando a faixa de tarifa.
        ...
        private void DesenhaCanhotoInferior()
        {
            ...
            // Serie/numero: a data recebe mais espaco para nao colidir com a coluna anterior.
